#' Session navbar left slot UI
#'
#' Creates the left side navbar content for blockr.dock integration:
#' - Hamburger menu with Workflows and History tabs
...
#' @export
session_navbar_left_ui <- function(id) {
  ns <- NS(id)
  ...
  tagList(
    ...
    htmltools::htmlDependency(
      ...
      pkg_version(),
      src = pkg_file("assets"),
      stylesheet = "css/session-navbar.css",
      script = "js/session-navbar.js"
    ),
